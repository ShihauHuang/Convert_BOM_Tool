...
def Create_BOM (product_dict , kit_list , file_name , folder_full_path, _Date, file_time) :
    ...
    sheet['B3'].font = Font(name=font_family, size=medium_font_size, bold=False, color='FF0000')
    ...
    sheet['C3'].font = Font(name=font_family, size=large_font_size, bold=False, color='FF0000')
